...
//         isScrolled
//           ? "bg-gradient-to-r from-indigo-600 via-purple-500 to-indigo-600 shadow-lg"
//           : "bg-transparent"
//       }`}
//       initial={{ y: -100 }}
//       animate={{ y: 0 }}
...
//     >
//       <nav
//         className="container mx-auto flex items-center justify-between py-5 px-6 lg:px-8"
//         aria-label="Global"
//       >
//         <div className="flex lg:flex-1">
//           <Link
//             to="/"
//             className="rounded focus:outline-none focus:ring-4 focus:ring-indigo-300"
//           >
//             <span className="sr-only">BlockStone</span>
//             <img
...
//           <button
//             type="button"
//             className="rounded-lg p-3 text-white hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-300 transition-transform duration-300 ease-in-out"
...
//               key={item.name}
//               href={item.href}
//               className="text-sm font-semibold text-white hover:text-indigo-200 transition-all duration-300 ease-out rounded-lg px-3 py-2 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-indigo-300 focus:ring-offset-2"
...
//           <Link
//             to="/market"
//             className="text-sm font-semibold text-white hover:text-indigo-200 transition-all duration-300 ease-out rounded-lg px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-purple-500 hover:to-indigo-500 focus:outline-none focus:ring-4 focus:ring-indigo-300 hover:shadow-2xl"
//           >
//             Launch App{" "}
...
//               exit={{ x: "100%" }}
//               transition={{ duration: 0.5 }}
//               className="lg:hidden fixed inset-y-0 right-0 z-50 w-80 max-w-full bg-white rounded-l-lg shadow-2xl px-6 py-6 sm:w-64"
//               open={mobileMenuOpen}
...
//                   <button
//                     type="button"
//                     className="rounded-lg p-3 text-gray-700 hover:bg-gray-300 focus:outline-none focus:ring-4 focus:ring-indigo-300 transition-transform duration-300 ease-in-out"
//                     onClick={() => setMobileMenuOpen(false)}
//                   >
...
//                       key={item.name}
//                       href={item.href}
//                       className="block rounded-lg px-4 py-3 text-lg font-medium text-gray-800 hover:bg-indigo-100 transition-all duration-300 ease-out focus:outline-none focus:ring-4 focus:ring-indigo-300"
//                       onClick={() => setMobileMenuOpen(false)}
...
//                     <Link
//                       to="/market"
//                       className="block rounded-lg px-4 py-3 text-lg font-medium text-white bg-gradient-to-r from-indigo-500 to-purple-500 hover:bg-gradient-to-l transition-all duration-300 ease-out focus:outline-none focus:ring-4 focus:ring-indigo-300 hover:shadow-2xl"
//                       onClick={() => setMobileMenuOpen(false)}
//                     >
//                       Launch App
//                     </Link>
