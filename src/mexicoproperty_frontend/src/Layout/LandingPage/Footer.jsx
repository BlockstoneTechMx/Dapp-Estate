...
//             &copy; {new Date().getFullYear()} BlockStone, Inc. All rights
//             reserved.
//           </p>
//         </div>
//       </div>
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:py-16 sm:px-8 lg:px-12">
        <div className="flex flex-col items-center lg:flex-row lg:justify-between">
          ...
          <div className="flex items-center space-x-4">
            <img
              src="images/LandingPage/logob3.png"
              alt="BlockStone"
              width={50}
              className="rounded-lg shadow-lg"
            />
            <p className="text-lg font-semibold text-gray-100">BlockStone</p>
          </div>
        ...
        <div className="mt-8 text-center text-gray-300">
          ...
          <p className="text-sm mt-2">support@BlockStone.com</p>
        ...
        <div className="mt-8 border-t border-gray-700 pt-6 text-center">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} BlockStone, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
